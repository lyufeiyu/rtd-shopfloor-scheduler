...
function renderAssistant(){
 ...
 if(!host.firstElementChild){
  ...
  host.querySelector('#assistant-close').onclick=()=>{S.assistantOpen=false;render();};
 }
 if(assistantDataset!==S.dataset?.id){assistantDataset=S.dataset?.id;assistantDraft=null;const answer=host.querySelector('.assistant-answer');if(answer)answer.textContent='';}
}
